...
export const writeThemeisleComponentSkeleton = (
  componentName,
  dir,
  componentCode,
) => {
...
<Meta of={${componentName}} title="Themeisle/${componentName}" />
...
const meta: Meta<typeof Example> = { title: "Themeisle/${componentName}", component: Example };
