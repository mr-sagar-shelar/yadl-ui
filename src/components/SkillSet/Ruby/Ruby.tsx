...
const Ruby = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g fillRule="evenodd" clipPath="url(#prefix__a)" clipRule="evenodd">
      <path
        fill="url(#prefix__b)"
        d="M177.454 156.477 74.685 217.5l133.066-9.029L218 74.294z"
      />
      <path
        fill="url(#prefix__c)"
        d="m207.969 208.379-11.437-78.939-31.153 41.137z"
      />
      <path
        fill="url(#prefix__d)"
        d="m208.124 208.379-83.79-6.577-49.204 15.527z"
      />
      <path
        fill="url(#prefix__e)"
        d="m75.248 217.346 20.932-68.573-46.06 9.849z"
      />
      <path
        fill="url(#prefix__f)"
        d="m165.371 170.804-19.26-75.442-55.119 51.666z"
      />
      <path
        fill="url(#prefix__g)"
        d="m213.63 96.425-52.102-42.554-14.509 46.906z"
      />
      <path
        fill="url(#prefix__h)"
        d="m189.264 38.7-30.643 16.934-19.333-17.162z"
      />
      <path
        fill="url(#prefix__i)"
        d="m38 181.624 12.837-23.412-10.384-27.891z"
      />
      <path
        fill="#fff"
        d="m39.763 129.44 10.447 29.635 45.398-10.185 51.829-48.168 14.627-46.46L139.033 38 99.877 52.654C87.54 64.128 63.6 86.832 62.738 87.259c-.854.436-15.807 28.699-22.975 42.181"
      />
      <path
        fill="url(#prefix__j)"
        d="M76.448 76.202c26.736-26.51 61.205-42.172 74.432-28.826 13.22 13.346-.799 45.779-27.536 72.279-26.737 26.501-60.778 43.027-73.997 29.681-13.228-13.337.364-46.633 27.1-73.134"
      />
      <path
        fill="url(#prefix__k)"
        d="m75.248 217.319 20.768-68.792 68.973 22.159c-24.938 23.384-52.674 43.153-89.74 46.633"
      />
      <path
        fill="url(#prefix__l)"
        d="m147.528 100.586 17.707 70.136c20.831-21.904 39.528-45.452 48.685-74.578z"
      />
      <path
        fill="url(#prefix__m)"
        d="M213.739 96.498c7.086-21.386 8.722-52.066-24.694-57.762L161.627 53.88z"
      />
      <path
        fill="#9E1209"
        d="M38 181.315c.981 35.296 26.446 35.822 37.294 36.132L50.237 158.93z"
      />
      <path
        fill="url(#prefix__n)"
        d="M147.627 100.695c16.008 9.839 48.269 29.599 48.923 29.962 1.017.573 13.909-21.74 16.835-34.35z"
      />
      <path
        fill="url(#prefix__o)"
        d="m95.99 148.527 27.763 53.565c16.416-8.903 29.272-19.75 41.046-31.37z"
      />
      <path
        fill="url(#prefix__p)"
        d="m50.128 159.002-3.933 46.842c7.422 10.139 17.633 11.02 28.345 10.23-7.75-19.287-23.23-57.853-24.412-57.072"
      />
      <path
        fill="url(#prefix__q)"
        d="m161.464 53.999 55.155 7.74c-2.943-12.474-11.983-20.523-27.391-23.04z"
      />
    </g>
    <defs>
      <linearGradient
      ...
      <radialGradient
        ...
        cy={0}
        r={1}
        gradientTransform="translate(168.67 110.124)scale(45.7496)"
        gradientUnits="userSpaceOnUse"
      >
      ...
      <radialGradient
        ...
        cy={0}
        r={1}
        gradientTransform="translate(105.313 170.414)scale(60.818)"
        gradientUnits="userSpaceOnUse"
      >
      ...
      <clipPath id="prefix__a">
        <path fill="#fff" d="M38 38h180v179.5H38z" />
      </clipPath>
    </defs>
  </svg>
);
const Memo = memo(Ruby);
export default Memo;
