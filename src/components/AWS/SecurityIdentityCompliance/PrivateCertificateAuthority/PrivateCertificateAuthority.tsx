...
const PrivateCertificateAuthority = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g clipPath="url(#prefix__a)">
      <path fill="url(#prefix__b)" d="M0 0h80v80H0z" />
    </g>
    <g clipPath="url(#prefix__c)" transform="translate(12 12)">
      <path fill="#FFF" d="M0 0h56v56H0z" />
    </g>
  </svg>
);
const Memo = memo(PrivateCertificateAuthority);
export default Memo;
