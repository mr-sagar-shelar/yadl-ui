...
const Memorystore = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <style>
        {
          ".prefix__cls-1{fill:#669df6}.prefix__cls-2{fill:#4285f4;fill-rule:evenodd}"
        }
      </style>
    </defs>
    <g data-name="Product Icons">
      ...
      />
      <path
        d="M5.33 22h13.34V2H5.33Zm6-9H8l4.67-7.74V11H16l-4.67 7.74Z"
        style={{
          fillRule: "evenodd",
          fill: "#aecbfa",
        }}
      />
      <path
        d="M11.33 22v-3.23L16 11.03h-3.33V2h6v20z"
        style={{
          fill: "#669df6",
          fillRule: "evenodd",
        }}
