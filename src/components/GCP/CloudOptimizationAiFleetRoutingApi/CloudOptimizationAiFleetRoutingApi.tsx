...
const CloudOptimizationAiFleetRoutingApi = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <style>{".prefix__st0{fill:#aecbfa}.prefix__st1{fill:#4285f4}"}</style>
    <path
...
const Memo = memo(CloudOptimizationAiFleetRoutingApi);
export default Memo;
