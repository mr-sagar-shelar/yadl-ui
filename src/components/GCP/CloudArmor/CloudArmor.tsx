...
const CloudArmor = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
    <defs>
      <style>
        {".prefix__cls-1{fill:#aecbfa}.prefix__cls-2{fill:#669df6}"}
      </style>
    </defs>
    <g data-name="Product Icons">
      ...
      />
      <circle cx={14.69} cy={14.62} r={1.42} className="prefix__cls-2" />
      <circle cx={13.85} cy={10.45} r={1.42} className="prefix__cls-2" />
      <circle cx={9.69} cy={9.6} r={1.42} className="prefix__cls-2" />
    </g>
  </svg>
);
const Memo = memo(CloudArmor);
export default Memo;
