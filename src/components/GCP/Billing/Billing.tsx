...
const Billing = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g fillRule="evenodd">
      ...
      <path
        fill="#5C85DE"
        d="M22.5 20.2H12V3.8h10.5c.8 0 1.5.7 1.5 1.5v13.5c0 .8-.7 1.4-1.5 1.4"
      />
      ...
      <path
        fill="#FFF"
        d="M13.5 15.8H15v1.5h-1.5zM16.5 15.8H18v1.5h-1.5zM19.5 15.8H21v1.5h-1.5z"
      />
    </g>
  </svg>
);
const Memo = memo(Billing);
export default Memo;
