...
const CohortAnalysis = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      d="M33.986 35.186h73.985v49.323H33.986z"
    />
    ...
    <path
      fill="var(--color-primary)"
      d="M254.091 35.186h73.985v49.323h-73.985z"
    />
    <path
      fill="var(--color-primary)"
    ...
    <path
      fill="var(--color-primary)"
      d="M107.354 82.043h73.985v49.323h-73.985z"
    />
    <path
      fill="var(--color-primary)"
    ...
    <path
      fill="var(--color-primary)"
      d="M327.459 82.043h73.985v49.323h-73.985z"
    />
    <path
      fill="var(--color-primary)"
    ...
    <path
      fill="var(--color-primary)"
      d="M547.563 82.043h73.985v49.323h-73.985z"
    />
    ...
    <path
      fill="var(--color-primary)"
      d="M254.091 128.9h73.985v49.323h-73.985z"
    />
    <path
      fill="var(--color-primary)"
    ...
    <path
      fill="var(--color-primary)"
      d="M107.354 222.614h73.985v49.323h-73.985z"
    />
    ...
    <path
      fill="var(--color-primary)"
      d="M33.986 269.471h73.985v49.323H33.986z"
    />
    ...
    <path
      fill="var(--color-primary)"
      d="M254.091 269.471h73.985v49.323h-73.985z"
    />
    ...
    <path
      ...
      opacity={0.8}
    />
    <path fill="#3f3d56" d="M934.007 543.231H676.269v-2.106h258.12z" />
    <path
      fill="#ffb8b8"
      d="m763 538 13.5-1.5v-24l-14.5.5zM833 538l-14.5-1.5L821 513l16.5-.5z"
    />
    <path
      fill="#2f2e41"
      d="m756.5 516.5 21.67-.606c13.578-70.971 26.819-136.614 48.33-191.394l-9 191h23l35-214-80-8c-26.794 70.803-38.953 145.351-39 223M750.45 557.433a12.16 12.16 0 0 0 13.615-3.51l5.435-6.423 10-5-1.595-16.743a1.433 1.433 0 0 0-2.646-.615l-5.76 9.358c-2.123-7.654-5.792-11.631-11.54-10.664a11.95 11.95 0 0 0-8.388 6.246l-5.502 10.217a12.164 12.164 0 0 0 6.38 17.134M844.55 557.433a12.16 12.16 0 0 1-13.615-3.51L825.5 547.5l-10-5 1.595-16.743a1.433 1.433 0 0 1 2.646-.615l5.759 9.358c2.124-7.654 5.793-11.631 11.54-10.664a11.95 11.95 0 0 1 8.389 6.246l5.501 10.217a12.164 12.164 0 0 1-6.38 17.134"
    />
    <circle cx={836} cy={101} r={24} fill="#ffb8b8" />
    <path fill="#ffb8b8" d="M850.5 145.5h-30v-32h30z" />
    <path
      fill="#e6e6e6"
      d="M799 294c25.128 5.889 51.7 14.414 69 6l-.5-155.5a31.22 31.22 0 0 1-17-15l-12 10-18-11c-6.257 7.56-14.663 15.514-24.5 18.5Z"
    />
    <path
      fill="#2f2e41"
    ...
    <path
      fill="#ffb8b8"
      d="m888 310-6.907 13.815a10.726 10.726 0 0 0 7.182 15.248 10.726 10.726 0 0 0 13.133-10.116L902 310v-15h-14Z"
    />
    <path
      fill="#2f2e41"
      d="M841.5 268.5c-.985 32.546-4.314 37.455-52 36 10.902-54.361 10.538-105.856-3-154 13.677-6.558 25.69-14.14 34-24-.565 1.493.927 2.005.5 3.5-7.128 24.985 4.622 51.215 20.5 73.5Z"
    />
    <path
      fill="#ffb8b8"
      d="m782 306 6.907 13.815a10.726 10.726 0 0 1-7.182 15.248 10.726 10.726 0 0 1-13.133-10.116L768 306v-15h14Z"
    />
    <path
      fill="#2f2e41"
      d="M837.32 60.03a25.34 25.34 0 0 1 11.575 3.407c.812.472.437 2.175 1.186 2.73.945.7 2.995.275 3.83 1.094a25.39 25.39 0 0 1 7.551 20.457l-1.331 13.236-3.14-3.434A32.74 32.74 0 0 0 835.157 86.8q-.534-.036-1.07-.057l2.416-4.228-4.199 4.2a41 41 0 0 0-5.72.465l3.212-5.623-6.165 6.165a16.48 16.48 0 0 0-11.518 9.394l-.685 1.518-.767-12.628A25.453 25.453 0 0 1 837.32 60.03"
    />
    <ellipse cx={859.499} cy={100.002} fill="#ffb8b8" rx={1.916} ry={4.551} />
    <ellipse cx={811.593} cy={98.565} fill="#ffb8b8" rx={1.916} ry={4.551} />
    <path
      fill="#2f2e41"
      d="m785 300-23.5 1.5 12-131.877a22.7 22.7 0 0 1 16.464-21.827l4.536-1.296c6.52 54.19-.782 106.073-9.5 153.5M886 303l18 1-6.5-132.377a22.7 22.7 0 0 0-16.464-21.827L876.5 148.5c-6.52 54.19.782 107.073 9.5 154.5"
    />
  </svg>
);
