...
const Server_clusterServerCluster = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="#ccc"
      d="M444.936 604.807a260.064 260.064 0 1 1 183.893-76.17 258.37 258.37 0 0 1-183.893 76.17m0-518.129c-142.297 0-258.065 115.768-258.065 258.065S302.64 602.807 444.936 602.807 703 487.04 703 344.743 587.232 86.678 444.936 86.678"
    />
    ...
    />
    <circle cx={524} cy={388.807} r={6} fill="var(--color-primary)" />
    <circle cx={545} cy={388.807} r={6} fill="var(--color-primary)" />
    <circle cx={566} cy={388.807} r={6} fill="var(--color-primary)" />
    <circle cx={524} cy={502.807} r={6} fill="var(--color-primary)" />
    <circle cx={545} cy={502.807} r={6} fill="var(--color-primary)" />
    <circle cx={566} cy={502.807} r={6} fill="var(--color-primary)" />
    <circle cx={524} cy={616.807} r={6} fill="var(--color-primary)" />
    <circle cx={545} cy={616.807} r={6} fill="var(--color-primary)" />
    <circle cx={566} cy={616.807} r={6} fill="var(--color-primary)" />
    <path fill="#3f3d56" d="M0 708.807h888v2H0z" />
    <path
      fill="#e6e6e6"
      d="M241.879 271.065v185.991a14.675 14.675 0 0 1-14.673 14.673h-72.278a14.677 14.677 0 0 1-14.678-14.673V271.065a14.677 14.677 0 0 1 14.678-14.673h8.768A6.978 6.978 0 0 0 170.15 266h41.208a6.978 6.978 0 0 0 6.455-9.607h9.392a14.675 14.675 0 0 1 14.673 14.673"
    />
    <path fill="#fff" d="M145.064 291.91h92v128h-92z" />
    <path fill="#e6e6e6" d="M171.186 379.927h36.72v2.098h-36.72z" />
    <path
      fill="var(--color-primary)"
      d="M171.149 387.632h56.817v2.098h-56.817z"
    />
    <path
      fill="#e6e6e6"
    ...
    <path
      fill="var(--color-primary)"
      d="M154.533 386.582h4.197v4.197h-4.197z"
    />
    <path
      fill="#e6e6e6"
    ...
    <path fill="var(--color-primary)" d="M376.74 67.807h75.705v2.796H376.74z" />
    <path
      fill="#e6e6e6"
    ...
    />
    <path fill="var(--color-primary)" d="M354.601 66.409h5.592v5.592h-5.592z" />
    <path
      fill="#e6e6e6"
    ...
    />
    <path fill="var(--color-primary)" d="M321.006 0H566.89v10.446H321.006z" />
    ...
    <path
      fill="var(--color-primary)"
      d="M688.846 361.468h46.802v1.728h-46.802z"
    />
    <path
      fill="#e2e2e2"
    ...
    />
    <path fill="var(--color-primary)" d="M675.16 360.604h3.457v3.457h-3.457z" />
    <path
      fill="#e2e2e2"
