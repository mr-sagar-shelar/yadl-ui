...
const Themeisle498 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="url(#prefix__a)"
      d="M731.008 132.447c-19.058 9.454-44.352-2.702-44.352-2.702s5.622-27.477 24.689-36.918c19.058-9.453 44.342 2.689 44.342 2.689s-5.622 27.477-24.679 36.931"
    />
    <path
      fill="url(#prefix__b)"
      d="M410.616 138.108c18.872 11.312 45.949.855 45.949.855s-3.541-28.791-22.425-40.089c-18.872-11.311-45.937-.868-45.937-.868s3.54 28.791 22.413 40.102"
    />
    <circle
      r={12.977}
      fill="#E1E4E5"
    ...
    />
    <circle r={12.5} fill="#E1E4E5" transform="matrix(-1 0 0 1 388.64 493.5)" />
    <circle
      r={14.267}
      fill="#E1E4E5"
