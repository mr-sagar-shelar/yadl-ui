...
const Themeisle177 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={12}
      d="M439.062 238.311h42.605c11.759 0 21.303 9.543 21.303 21.302v42.605c0 11.759-9.544 21.303-21.303 21.303h-42.605c-11.759 0-21.302-9.544-21.302-21.303v-42.605c0-11.759 9.543-21.302 21.302-21.302"
      clipRule="evenodd"
    />
    <path
      stroke="#E1E4E5"
    ...
    <path
      fill="url(#prefix__a)"
      d="M764.964 231.931c15.739-3.729 32.386 9.619 32.386 9.619s-8.884 19.386-24.628 23.103c-15.739 3.729-32.381-9.607-32.381-9.607s8.884-19.386 24.623-23.115"
    />
    <circle cx={207.865} cy={321.348} r={15.854} fill="var(--color-primary)" />
    <circle
      r={11.903}
      fill="var(--color-primary)"
    ...
    <path
      fill="#E1E4E5"
      d="M129.51 372.474h-.283c-1.677-23.752-19.341-24.117-19.341-24.117s19.479-.38 19.479-27.825c0 27.445 19.478 27.825 19.478 27.825s-17.657.365-19.333 24.117m14.285-231.006h-.205c-1.217-17.696-14.04-17.968-14.04-17.968s14.14-.284 14.14-20.73c0 20.446 14.139 20.73 14.139 20.73s-12.817.272-14.034 17.968"
    />
    <defs>
      <linearGradient
        id="prefix__a"
