...
const Themeisle471 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="url(#prefix__a)"
      d="M625.858 189.836c-10.581 18.884-33.756 21.479-70.883 17.89-27.922-2.704-53.385-4.796-81.309-20.021-19.545-10.648-35.017-25.056-46.309-39.049-12.236-15.159-29.316-32.459-20.943-49.647 11.506-23.61 78.047-43.496 142.66-10.977 70.977 35.733 87.136 83.347 76.784 101.804"
    />
    <path
      fill="url(#prefix__b)"
      d="M185.777 194.515c15.47 9.272 37.664.701 37.664.701s-2.902-23.6-18.381-32.861c-15.47-9.272-37.655-.712-37.655-.712s2.902 23.6 18.372 32.872"
    />
    <circle
      cx={693.726}
      cy={363.309}
    ...
    <path
      fill="#E1E4E5"
      d="M666.62 409.343h.241c1.428 20.231 16.474 20.543 16.474 20.543s-16.592.323-16.592 23.7c0-23.377-16.591-23.7-16.591-23.7s15.04-.312 16.468-20.543"
    />
    <path
      fill="transparent"
      stroke="#E1E4E5"
    ...
    />
    <circle cx={450.673} cy={463.644} r={97.176} fill="var(--color-primary)" />
    <rect
      width={13.947}
      height={71.881}
      x={443.573}
