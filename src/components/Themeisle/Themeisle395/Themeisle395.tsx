...
const Themeisle395 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="var(--color-primary)"
      fillRule="evenodd"
      d="M622.189 132.672c95.463 95.463 95.463 250.239 0 345.701s-250.239 95.463-345.701 0-95.463-250.238 0-345.701 250.239-95.463 345.701 0"
      clipRule="evenodd"
    />
    <path
      fill="transparent"
      fillRule="evenodd"
      d="m474.407 255.382 83.574 33.435-150.417 167.121 16.704-116.982-83.574-33.435 150.417-150.417z"
      clipRule="evenodd"
    />
  </svg>
);
const Memo = memo(Themeisle395);
export default Memo;
