...
const Themeisle328 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <circle cx={449.9} cy={300.131} r={275.131} fill="url(#prefix__a)" />
    <path
      fill="url(#prefix__b)"
      d="M809.299 286.817c-24.968 12.386-58.107-3.54-58.107-3.54s7.365-35.999 32.347-48.368c24.968-12.385 58.094 3.523 58.094 3.523s-7.365 35.999-32.334 48.385"
    />
    <path
      fill="url(#prefix__c)"
      d="M96 366.65c28.209 16.906 68.68 1.277 68.68 1.277s-5.292-43.034-33.518-59.921c-28.209-16.907-68.662-1.297-68.662-1.297s5.29 43.034 33.5 59.941"
    />
    <circle
      cx={760.172}
      cy={203.823}
    ...
    <path
      fill="#E1E4E5"
      d="M803.149 328.744h.225c1.334 18.905 15.394 19.196 15.394 19.196s-15.504.303-15.504 22.147c0-21.844-15.503-22.147-15.503-22.147s14.053-.291 15.388-19.196M236.847 512.531h.2c1.184 17.111 13.659 17.374 13.659 17.374s-13.757.274-13.757 20.044c0-19.77-13.756-20.044-13.756-20.044s12.47-.263 13.654-17.374"
    />
    <circle cx={449.155} cy={299.832} r={233.316} fill="var(--color-primary)" />
    <path
      stroke="transparent"
      strokeWidth={12.884}
