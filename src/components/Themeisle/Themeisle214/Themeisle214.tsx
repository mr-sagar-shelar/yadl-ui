...
const Themeisle214 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <circle cx={444.295} cy={290.146} r={222.498} fill="url(#prefix__a)" />
    <path
      fill="transparent"
      fillRule="evenodd"
      stroke="#E1E4E5"
    ...
    <path
      ...
      stroke="#E1E4E5"
      strokeWidth={4}
      d="M486.221 375.407H350.912c-12.098 0-17.31-15.649-7.411-22.589q.208-.15.419-.295c14.096-9.678 32.595-8.799 32.595-8.799s2.64-52.368 52.411-52.368c44.999 0 62.943 44.123 69.416 68.433 2.102 7.897-3.94 15.618-12.121 15.618z"
      clipRule="evenodd"
    />
    <path
      ...
      strokeWidth={23}
      d="M309.844 285.941c0 78.946 86.003 164.049 117.375 192.47 6.501 5.888 16.055 5.888 22.555 0 31.355-28.421 117.358-113.524 117.358-192.47 0-69.192-57.598-125.283-128.644-125.283s-128.644 56.091-128.644 125.283"
      clipRule="evenodd"
    />
    <path
      stroke="transparent"
