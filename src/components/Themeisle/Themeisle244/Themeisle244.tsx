...
const Themeisle244 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="transparent"
      fillRule="evenodd"
      d="M615.876 174.663c83.452 83.451 83.452 218.751 0 302.203s-218.752 83.452-302.203 0c-83.452-83.452-83.452-218.752 0-302.203 83.429-83.43 218.751-83.43 302.203 0"
      clipRule="evenodd"
    />
    <path
      stroke="#E1E4E5"
    ...
    <path
      fill="transparent"
      fillRule="evenodd"
      d="M374.789 519.649V407.428c0-10.572 2.474-21.009 7.265-30.434l82.71-163.687 82.709 163.687a67.2 67.2 0 0 1 7.266 30.434v112.221"
      clipRule="evenodd"
    />
    <path
      stroke="#E1E4E5"
    ...
    <path
      fill="#E1E4E5"
      d="M188.589 178.697h.133c.788 11.165 9.092 11.336 9.092 11.336s-9.156.179-9.156 13.08c0-12.901-9.157-13.08-9.157-13.08s8.3-.171 9.088-11.336m9.537 299.14h.128c.756 11.132 8.728 11.303 8.728 11.303s-8.791.179-8.791 13.041c0-12.862-8.791-13.041-8.791-13.041s7.969-.171 8.726-11.303"
    />
  </svg>
);
const Memo = memo(Themeisle244);
export default Memo;
