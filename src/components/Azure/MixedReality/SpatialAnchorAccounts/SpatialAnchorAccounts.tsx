...
const SpatialAnchorAccounts = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    />
    <circle cx={8.22} cy={6.4} r={1.69} fill="url(#prefix__a)" />
    <circle cx={2.36} cy={10.94} r={1.69} fill="url(#prefix__b)" />
    <circle cx={8.22} cy={15.81} r={1.69} fill="url(#prefix__c)" />
    <path
      fill="url(#prefix__d)"
...
const Memo = memo(SpatialAnchorAccounts);
export default Memo;
