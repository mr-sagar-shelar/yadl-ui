...
const Monitor = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <ellipse cx={9} cy={9} fill="url(#prefix__a)" rx={8.5} ry={8.47} />
    <ellipse cx={9} cy={9} fill="#fff" rx={7.4} ry={7.37} />
    <path
      fill="#9cebff"
      d="M2.72 9.44a6.24 6.24 0 0 0 1.82 4l2-2a3.53 3.53 0 0 1-1-2Z"
    />
    <path
      fill="#32bedd"
    ...
    <path
      fill="#50e6ff"
      d="m6.22 6.85-2-2a6.16 6.16 0 0 0-1.5 3.71h2.79a3.6 3.6 0 0 1 .71-1.71"
    />
    <path
      fill="#f04049"
      d="M14.14 7a.45.45 0 0 0-.57-.25L9.45 8.41l.32.81 4.12-1.63a.44.44 0 0 0 .25-.59"
    />
    <circle cx={9} cy={9} r={1.2} fill="url(#prefix__b)" />
  </svg>
);
const Memo = memo(Monitor);
export default Memo;
