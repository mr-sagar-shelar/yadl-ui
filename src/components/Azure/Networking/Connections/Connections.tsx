...
const Connections = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <g clipPath="url(#prefix__b)">
      <path
        fill="#5e9624"
        d="m10.43 8.19 2.73 2.88-.77.8-3.5-3.68 3.45-3.63.77.8z"
      />
    ...
    <g clipPath="url(#prefix__c)">
      <path
        fill="#5e9624"
        d="m7.26 9.76-2.72 2.88.76.8 3.5-3.68-3.45-3.63-.77.8z"
      />
      <path fill="#86d633" d="m4.54 12.64 2.72-2.88.76.8-2.72 2.88z" />
    </g>
  </svg>
);
const Memo = memo(Connections);
export default Memo;
