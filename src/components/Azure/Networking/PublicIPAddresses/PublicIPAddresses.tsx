...
const PublicIPAddresses = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <circle cx={12.82} cy={10.19} r={1.38} fill="#f2f2f2" />
    <circle cx={9.06} cy={10.19} r={1.38} fill="#f2f2f2" />
    <circle cx={5.18} cy={10.19} r={1.38} fill="#f2f2f2" />
    <rect
      width={12.43}
      height={1.46}
      x={2.79}
...
const Memo = memo(PublicIPAddresses);
export default Memo;
