...
const PublicIPAddressesClassic = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="url(#prefix__a)"
      d="M.5 5.66h17v9.48a.57.57 0 0 1-.57.57H1.07a.57.57 0 0 1-.57-.57z"
    />
    <path
      fill="#0078d4"
      d="M1.07 2h15.86a.57.57 0 0 1 .57.57v3.09H.5V2.6a.57.57 0 0 1 .57-.6"
    />
...
const Memo = memo(PublicIPAddressesClassic);
export default Memo;
