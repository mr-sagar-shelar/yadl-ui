...
const ApplicationGatewayContainers = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    />
    <circle cx={9.02} cy={16.045} r={1.421} fill="url(#prefix__c)" />
    <path
      fill="#fff"
      d="M6.581 8.279a2.449 2.449 0 1 0 3.106-2.343v-1.75a1.5 1.5 0 1 0-1.378 0V5.98a2.43 2.43 0 0 0-1.728 2.299"
    />
    <circle cx={9.02} cy={8.288} r={1.421} fill="url(#prefix__d)" />
    <circle cx={3.106} cy={14.238} r={1.421} fill="url(#prefix__e)" />
    <circle cx={14.951} cy={14.238} r={1.421} fill="url(#prefix__f)" />
  </svg>
);
const Memo = memo(ApplicationGatewayContainers);
export default Memo;
