...
const FrontDoorandCDNProfiles = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#50e6ff"
      d="m12.61 6.37-3.49-2a.25.25 0 0 0-.31.15s0 .06 0 .08v12.08a.25.25 0 0 0 .24.25h.08l3.49-2.06a.25.25 0 0 0 .17-.23v-8a.26.26 0 0 0-.18-.27"
    />
  </svg>
);
const Memo = memo(FrontDoorandCDNProfiles);
export default Memo;
