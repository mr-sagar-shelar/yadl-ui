...
const CustomerLockboxforMicrosoftAzure = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="#fff"
      d="M7.87 8.9a4.13 4.13 0 0 1-2.23-.65L7.85 14 10 8.28a4 4 0 0 1-2.13.62"
    />
    <circle cx={7.87} cy={4.78} r={4.13} fill="url(#prefix__b)" />
    <rect
      width={8.42}
      height={4.15}
      x={9.08}
    ...
    <path
      fill="#32bedd"
      d="M13.29 13.2H9.64a.56.56 0 0 0-.56.56v3a.56.56 0 0 0 .56.56h3.65Z"
    />
    <path
      fill="#fff"
...
const Memo = memo(CustomerLockboxforMicrosoftAzure);
export default Memo;
