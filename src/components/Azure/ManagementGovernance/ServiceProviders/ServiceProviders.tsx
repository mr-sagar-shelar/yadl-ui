...
const ServiceProviders = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="#fff"
      d="M7.48 8.34a4.1 4.1 0 0 1-2.21-.65l2.19 5.71 2.17-5.68a4 4 0 0 1-2.15.62"
      opacity={0.8}
    />
    <circle cx={7.48} cy={4.25} r={4.08} fill="url(#prefix__b)" />
    <path
      fill="url(#prefix__c)"
...
const Memo = memo(ServiceProviders);
export default Memo;
