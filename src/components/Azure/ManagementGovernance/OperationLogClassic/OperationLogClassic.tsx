...
const OperationLogClassic = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#005ba1"
      d="M1.93 2.11 3.14.7a.6.6 0 0 1 .45-.2H15.2a.81.81 0 0 1 .89.83v14.5a.57.57 0 0 1-.2.43l-1.3 1.19H2.72l-.81-.33Z"
    />
    <path
      fill="#fff"
...
const Memo = memo(OperationLogClassic);
export default Memo;
