...
const ResourcesProvider = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#5ea0ef"
      d="m8.881 9.269-2.416 1.403-2.416-1.404 2.416-1.405z"
    />
    ...
    <path
      fill="#50e6ff"
      d="m13.967 9.262-2.416 1.404-2.416-1.405 2.416-1.404z"
    />
...
const Memo = memo(ResourcesProvider);
export default Memo;
