...
const UserSubscriptions = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#fff"
      d="M7.9 9a4.1 4.1 0 0 1-2.27-.67l2.25 5.89 2.24-5.85A4.17 4.17 0 0 1 7.9 9"
      opacity={0.8}
    />
    <circle cx={7.9} cy={4.8} r={4.21} fill="url(#prefix__b)" />
    <path
      fill="url(#prefix__c)"
...
const Memo = memo(UserSubscriptions);
export default Memo;
