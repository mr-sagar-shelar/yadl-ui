...
const InfrastructureBackup = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="#003067"
      d="M3 6.38A1.08 1.08 0 0 1 4.06 5.3H9a1.08 1.08 0 0 1 1.08 1.08A1.08 1.08 0 0 1 9 7.47H4.06A1.08 1.08 0 0 1 3 6.38M3 3.17a1.08 1.08 0 0 1 1.06-1.08H9a1.08 1.08 0 0 1 1.08 1.08A1.08 1.08 0 0 1 9 4.25H4.06A1.08 1.08 0 0 1 3 3.17"
    />
    ...
    <path
      fill="#e6e6e6"
      d="M16.48 10.21c0 .64-1.43 1.17-3.21 1.17s-3.21-.53-3.21-1.17 1.44-1.16 3.21-1.16 3.21.52 3.21 1.16"
    />
    <path
      fill="#50e6ff"
      d="M15.73 10.12c0 .41-1.1.74-2.46.74s-2.46-.33-2.46-.74 1.1-.74 2.46-.74 2.46.33 2.46.74M13.68 8.66l2.13-2.13a.11.11 0 0 0-.08-.19h-1.24c0-2.57-1.37-5.13-3.84-5.13a6.68 6.68 0 0 1 2 5.13h-1.18a.11.11 0 0 0-.08.19l2.13 2.13a.12.12 0 0 0 .16 0"
    />
  </svg>
);
const Memo = memo(InfrastructureBackup);
export default Memo;
