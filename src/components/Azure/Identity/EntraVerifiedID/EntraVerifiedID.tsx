...
const EntraVerifiedID = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="#f2f2f2"
      d="M4.398 7.194a1.53 1.53 0 0 1-.811-.244l.811 2.145.82-2.13c-.247.151-.531.23-.82.229"
    />
    ...
    <path
      fill="#6df"
      d="M13.267 7.823H8.57a.741.741 0 0 0 0 1.482h3.211c.284-.592.712-1.144 1.486-1.483Z"
    />
    <path
      fill="url(#prefix__b)"
...
const Memo = memo(EntraVerifiedID);
export default Memo;
