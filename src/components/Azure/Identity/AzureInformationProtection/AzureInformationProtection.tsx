...
const AzureInformationProtection = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#198ab3"
      d="M11.42 16.4 5.2 13.3l6.22-3.07.28.58-5.05 2.49 5.05 2.53z"
    />
    <circle cx={5.94} cy={13.32} r={1.25} fill="url(#prefix__b)" />
    <circle cx={11.51} cy={10.64} r={1.25} fill="url(#prefix__c)" />
    <circle cx={11.51} cy={16.11} r={1.25} fill="url(#prefix__d)" />
  </svg>
);
const Memo = memo(AzureInformationProtection);
export default Memo;
