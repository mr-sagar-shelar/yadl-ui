...
const EntraConnect = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="url(#prefix__c)"
      d="m4.619 9.683.052.031 4.297 2.687 4.348-2.718h.001-.001L8.968 4.776z"
    />
    <path
      fill="url(#prefix__d)"
      fillOpacity={0.5}
      ...
      opacity={0.5}
    />
    <circle cx={13.484} cy={12.968} r={4.516} fill="url(#prefix__e)" />
    <path
      fill="#fff"
