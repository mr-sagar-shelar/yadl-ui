...
const EntraManagedIdentities = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="#ffca00"
      d="M16.512 10.831a1.18 1.18 0 0 0 .01-1.67l-.01-.01-2.035-2.035a1.18 1.18 0 0 0-1.669 0l-2.035 2.035a1.2 1.2 0 0 0 0 1.679l1.7 1.7a.33.33 0 0 1 .092.234v3.155a.37.37 0 0 0 .122.285l.773.773a.253.253 0 0 0 .376 0l.743-.743.448-.448a.153.153 0 0 0 0-.214l-.316-.315a.163.163 0 0 1-.014-.23l.014-.014.316-.316a.164.164 0 0 0 0-.224l-.316-.316a.152.152 0 0 1 0-.234l.316-.326a.153.153 0 0 0 0-.214l-.448-.448v-.163l1.934-1.944Zm-2.87-3.226a.672.672 0 1 1-.672.672c0-.371.301-.672.672-.672"
    />
    <path
      fill="#ff9300"
      d="M13.133 16.042a.14.14 0 0 0 .201.003.14.14 0 0 0 .043-.115v-2.605a.16.16 0 0 0-.061-.132.144.144 0 0 0-.199.034.14.14 0 0 0-.025.098v2.555a.15.15 0 0 0 .041.163Z"
      opacity={0.75}
    />
    <rect
      width={3.348}
...
const Memo = memo(EntraManagedIdentities);
export default Memo;
