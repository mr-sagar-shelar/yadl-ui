...
const EntraPrivlegedIdentityManagement = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="url(#prefix__c)"
      d="m5.64 9.845.04.025L9 11.945l3.359-2.1h.001-.001L9 6.055z"
    />
    <path
      fill="url(#prefix__d)"
...
const Memo = memo(EntraPrivlegedIdentityManagement);
export default Memo;
