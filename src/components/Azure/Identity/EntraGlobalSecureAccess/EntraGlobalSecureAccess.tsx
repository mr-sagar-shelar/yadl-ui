...
const EntraGlobalSecureAccess = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="url(#prefix__c)"
      d="M9 0a27.85 27.85 0 0 1 0 18c4.937 0 9-4.063 9-9a9 9 0 0 0-9-9"
    />
  </svg>
);
const Memo = memo(EntraGlobalSecureAccess);
export default Memo;
