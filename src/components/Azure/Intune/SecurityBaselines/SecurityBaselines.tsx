...
const SecurityBaselines = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="#9cebff"
      d="M6.29 8.65h10.78a.35.35 0 0 1 .37.33v8.19a.35.35 0 0 1-.37.33H6.29a.36.36 0 0 1-.37-.33V9a.36.36 0 0 1 .37-.35"
    />
    <path
      fill="#0078d4"
      d="M6.27 8.65h10.82a.33.33 0 0 1 .35.31v1.24H5.92V9a.33.33 0 0 1 .35-.31ZM15.87 13.41H8.76c-.16 0-.28.08-.28.16V14c0 .09.12.16.28.16h7.11c.16 0 .29-.07.29-.16v-.4c0-.11-.16-.19-.29-.19M15.87 11.61H8.76c-.16 0-.28.07-.28.16v.39c0 .09.12.16.28.16h7.11c.16 0 .29-.07.29-.16v-.39c0-.09-.16-.16-.29-.16M15.87 15.44H8.76c-.16 0-.28.07-.28.16v.4c0 .09.12.16.28.16h7.11c.16 0 .29-.07.29-.16v-.4c0-.09-.16-.16-.29-.16"
    />
...
const Memo = memo(SecurityBaselines);
export default Memo;
