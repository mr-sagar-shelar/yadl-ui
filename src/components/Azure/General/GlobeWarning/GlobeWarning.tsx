...
const GlobeWarning = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <linearGradient
        ...
        y1={803.355}
        y2={815.481}
        gradientTransform="scale(1 -1)rotate(-45 -1103.926 95.67)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset={0} stopColor="#ef7100" />
        <stop offset={0.82} stopColor="#f78d1e" />
      </linearGradient>
    </defs>
    <path
      fill="#999"
    ...
    />
    <circle cx={7.871} cy={6.563} r={6.063} fill="url(#prefix__a)" />
    <path
      fill="#f2f2f2"
    ...
    <path
      fill="#f78d1e"
      d="M8.254 7.571h-.646a.146.146 0 0 1-.152-.134l-.069-2.946a.144.144 0 0 1 .151-.14h.786a.144.144 0 0 1 .151.14l-.069 2.946a.146.146 0 0 1-.152.134"
    />
    <circle cx={7.931} cy={8.451} r={0.516} fill="#f78d1e" />
  </svg>
);
const Memo = memo(GlobeWarning);
export default Memo;
