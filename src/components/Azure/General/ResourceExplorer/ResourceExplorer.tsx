...
const ResourceExplorer = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      ...
      >
        <stop offset={0} stopColor="#e27908" />
        <stop offset={0.3} stopColor="#e57e0a" />
        <stop offset={0.64} stopColor="#ed8b11" />
    ...
    />
    <path fill="#ffca00" d="M12.84 8.03v4.18l-3.59 2.1v-4.19z" />
    <path fill="#ffe452" d="m12.84 8.03-3.59 2.1-3.6-2.1 3.6-2.11z" />
    <path fill="#ffd400" d="M9.25 10.13v4.18l-3.6-2.1V8.03z" />
  </svg>
);
