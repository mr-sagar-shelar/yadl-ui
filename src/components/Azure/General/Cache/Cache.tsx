...
const Cache = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <linearGradient
        ...
        y1={12.211}
        y2={12.211}
        gradientTransform="rotate(.147 988.63 1050.715)"
      ...
      >
        ...
        <stop offset={0.322} stopColor="#47daf5" />
        <stop offset={0.517} stopColor="#50e6ff" />
        <stop offset={0.664} stopColor="#4bdff9" />
        <stop offset={0.872} stopColor="#3dcdea" />
    ...
    <path
      fill="#e6e6e6"
      d="M12.7 2.724c0 1.22-2.72 2.2-6.068 2.193S.57 3.913.573 2.693 3.293.491 6.641.5s6.06 1 6.056 2.224"
    />
    <path
      fill="#50e6ff"
      d="M11.283 2.542c0 .775-2.085 1.4-4.651 1.392s-4.646-.64-4.644-1.416 2.085-1.4 4.651-1.393 4.646.641 4.644 1.417"
    />
    <path
      fill="#198ab3"
    ...
    <path
      fill="#e6e6e6"
      d="M17.457 8.046c0 .827-1.844 1.493-4.114 1.487s-4.109-.681-4.107-1.508 1.844-1.493 4.114-1.487 4.11.681 4.107 1.508"
    />
    <path
      fill="#50e6ff"
      d="M16.5 7.922c0 .526-1.413.948-3.154.944s-3.15-.434-3.148-.96 1.413-.949 3.153-.944 3.15.434 3.149.96"
    />
    <path
      fill="#198ab3"
      d="M13.346 8.133a7.6 7.6 0 0 0-2.5.355 7.3 7.3 0 0 0 2.495.378 7.3 7.3 0 0 0 2.5-.365 7.6 7.6 0 0 0-2.495-.368"
    />
    <path
      fill="#f2f2f2"
