...
const Recent = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <circle cx={8.88} cy={9.09} r={8.5} fill="url(#prefix__a)" />
    ...
    <rect
      ...
      fill="#7a7a7a"
      rx={0.52}
      transform="rotate(135 10.494 10.685)"
    />
    <circle cx={8.92} cy={9.08} r={1.2} fill="url(#prefix__b)" />
  </svg>
);
const Memo = memo(Recent);
export default Memo;
