...
const ContainerRegistries = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="#b3b3b3"
      d="m8.66 11.369-.36.21v-2.83l.36-.19Zm.71-3.22-.37.24v2.75l.37-.2Z"
    />
    <path fill="url(#prefix__b)" d="m17.99 13.119-2.16.74-7.9-1.42 2.15-1z" />
    ...
    <path
      fill="#b3b3b3"
      d="m8.61 16.389-.32-.16v-2.76l.32-.15Zm.77-3.45-.38.19v3.48l.37.19v-3.86Z"
    />
  </svg>
);
const Memo = memo(ContainerRegistries);
export default Memo;
