...
const AnomalyDetector = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="#50e6ff"
      d="m12.189 9.018-1.63 3.78-1.641-4.87L7.463 10.7 5.774 7.844H3.242a6 6 0 0 1 .222-.944h2.851l1.1 1.858 1.693-3.232 1.56 4.627.883-2.367h1.042l1.259 2.288h.935a6 6 0 0 1-.3.947h-1.196Z"
    />
    <path
      fill="#faa21d"
...
const Memo = memo(AnomalyDetector);
export default Memo;
