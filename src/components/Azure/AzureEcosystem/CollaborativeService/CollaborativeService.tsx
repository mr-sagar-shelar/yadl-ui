...
const CollaborativeService = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <circle cx={13.398} cy={4.597} r={2.85} fill="url(#prefix__a)" />
    <path
      fill="url(#prefix__b)"
      d="M2.849 5.382A2.85 2.85 0 1 0 5.7 8.231a2.85 2.85 0 0 0-2.851-2.849"
    />
    <path
      fill="url(#prefix__c)"
      d="M11.828 12.149A2.85 2.85 0 1 0 14.679 15a2.85 2.85 0 0 0-2.851-2.851"
    />
    {"\u200B"}
  </svg>
);
const Memo = memo(CollaborativeService);
export default Memo;
