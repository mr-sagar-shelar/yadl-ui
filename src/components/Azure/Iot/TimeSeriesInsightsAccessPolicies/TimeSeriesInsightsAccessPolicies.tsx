...
const TimeSeriesInsightsAccessPolicies = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <radialGradient
        ...
        cy={123.98}
        r={11.18}
        gradientTransform="matrix(.94 0 0 .94 -110.36 -108.4)"
    ...
    <path
      fill="#ff9300"
      d="M8.07 16.13a.25.25 0 0 0 .43-.19v-4.47a.24.24 0 0 0-.12-.22.25.25 0 0 0-.39.22v4.47a.27.27 0 0 0 .08.19"
      opacity={0.75}
    />
    <rect
      width={5.86}
...
const Memo = memo(TimeSeriesInsightsAccessPolicies);
export default Memo;
