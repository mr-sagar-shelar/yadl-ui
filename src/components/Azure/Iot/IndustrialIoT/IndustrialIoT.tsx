...
const IndustrialIoT = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <circle cx={2.053} cy={4.664} r={1.33} fill="url(#prefix__a)" />
    <circle cx={9.034} cy={16.67} r={1.33} fill="url(#prefix__b)" />
    <circle cx={15.947} cy={4.745} r={1.33} fill="url(#prefix__c)" />
    <path
      fill="#32bedd"
