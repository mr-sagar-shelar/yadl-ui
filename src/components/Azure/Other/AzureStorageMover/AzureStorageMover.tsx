...
const AzureStorageMover = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="url(#prefix__c)"
      d="M1.568 2.878a1.403 1.403 0 0 0 .9-2.656 1.404 1.404 0 0 0-.901 2.657Z"
    />
    <path
      fill="url(#prefix__d)"
      d="M.953 17.778a1.403 1.403 0 0 0 .9-2.656 1.403 1.403 0 0 0-.9 2.656"
    />
    <path
      fill="url(#prefix__e)"
      d="M16.148 17.328a1.403 1.403 0 0 0 .9-2.656 1.403 1.403 0 0 0-.9 2.656"
    />
  </svg>
);
const Memo = memo(AzureStorageMover);
export default Memo;
