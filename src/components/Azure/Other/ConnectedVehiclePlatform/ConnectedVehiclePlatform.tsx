...
const ConnectedVehiclePlatform = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="url(#prefix__c)"
      d="M8.91 12.186a1.177 1.177 0 1 1 1.31 1.039 1.156 1.156 0 0 1-1.31-1.039"
    />
    <path
      fill="url(#prefix__d)"
      d="M5.585 7.152a1.177 1.177 0 1 1 1.309 1.039 1.154 1.154 0 0 1-1.309-1.039"
    />
  </svg>
);
const Memo = memo(ConnectedVehiclePlatform);
export default Memo;
