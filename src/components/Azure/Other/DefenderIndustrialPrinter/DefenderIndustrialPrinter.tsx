...
const DefenderIndustrialPrinter = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g clipPath="url(#prefix__a)">
      ...
      <path
        fill="#5EA0EF"
        d="M.964 1.059h16.072c.535 0 .964.605.964 1.361v13.462H0V2.42C0 1.664.429 1.06.964 1.06"
      />
      ...
      <path
        fill="#C3F1FF"
        d="M14.718 8.365a.424.424 0 1 0 0-.847.424.424 0 0 0 0 .847"
      />
      <path
        fill="url(#prefix__b)"
        d="M3.176 11.647h11.33v5.93a.455.455 0 0 1-.424.423H3.6a.455.455 0 0 1-.424-.424z"
      />
    </g>
    <defs>
      <linearGradient
...
const Memo = memo(DefenderIndustrialPrinter);
export default Memo;
