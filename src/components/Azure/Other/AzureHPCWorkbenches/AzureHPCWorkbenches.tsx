...
const AzureHPCWorkbenches = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#fff"
      d="M8.336 8.251a1.2 1.2 0 0 1-.661-.2l.654 1.711.651-1.7a1.2 1.2 0 0 1-.644.189"
      opacity={0.8}
    />
    <circle cx={8.327} cy={7.029} r={1.222} fill="url(#prefix__d)" />
  </svg>
);
const Memo = memo(AzureHPCWorkbenches);
export default Memo;
