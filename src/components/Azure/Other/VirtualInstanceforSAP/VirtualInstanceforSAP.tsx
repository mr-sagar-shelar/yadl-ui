...
const VirtualInstanceforSAP = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    />
    <g fillRule="evenodd">
      <path fill="url(#prefix__c)" d="M2.427 10.028h6.788l6.643-6.644H2.427z" />
      <path
        fill="#fff"
...
const Memo = memo(VirtualInstanceforSAP);
export default Memo;
