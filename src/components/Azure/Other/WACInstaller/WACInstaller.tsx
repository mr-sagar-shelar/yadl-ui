...
const WACInstaller = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#003067"
      d="M3.111 6.658a1.157 1.157 0 0 1 1.098-1.205h5.026c.636.03 1.128.569 1.101 1.205a1.157 1.157 0 0 1-1.098 1.21H4.209a1.16 1.16 0 0 1-1.098-1.21M3.111 3.065a1.156 1.156 0 0 1 1.098-1.209h5.026c.638.03 1.13.572 1.101 1.209a1.157 1.157 0 0 1-1.098 1.21H4.209a1.16 1.16 0 0 1-1.098-1.21"
    />
    <circle cx={4.523} cy={3.065} r={0.812} fill="#50e6ff" />
    <circle cx={4.523} cy={6.658} r={0.812} fill="#50e6ff" />
    <path
      fill="url(#prefix__b)"
      d="M8.108 17.993v-6.114c0-.352.286-.637.639-.637h8.597a.64.64 0 0 1 .639.637v6.114z"
    />
    <path
      fill="url(#prefix__c)"
    ...
    <path
      fill="url(#prefix__d)"
      d="M3.147 11.698a3.147 3.147 0 1 0 0 6.294 3.147 3.147 0 0 0 0-6.294"
    />
    <path
      fill="#fff"
