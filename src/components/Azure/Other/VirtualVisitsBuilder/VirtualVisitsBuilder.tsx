...
const VirtualVisitsBuilder = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="#773adc"
      d="M.542 2.19h14.505a.52.52 0 0 1 .519.52V5.5H.02V2.71a.52.52 0 0 1 .52-.52Z"
    />
    <path
      fill="#f2f2f2"
...
const Memo = memo(VirtualVisitsBuilder);
export default Memo;
