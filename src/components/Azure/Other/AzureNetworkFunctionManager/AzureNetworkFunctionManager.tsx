...
const AzureNetworkFunctionManager = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" {...props}>
    <defs>
      ...
      <linearGradient
        ...
        y1={-214.048}
        y2={-221.784}
        gradientTransform="matrix(1 0 0 -1 427.126 -209.758)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset={0} stopColor="#9d79eb" />
        <stop offset={1} stopColor="#7548d6" />
      </linearGradient>
    </defs>
    <ellipse cx={7.961} cy={1.725} fill="url(#prefix__a)" rx={1.4} ry={1.454} />
    <path
      fill="#37c2b1"
    ...
    <ellipse
      ...
      ry={1.454}
    />
    <ellipse cx={3.116} cy={13.62} fill="url(#prefix__c)" rx={1.4} ry={1.454} />
    <g fill="#37c2b1">
    ...
    <path
      fill="#fff"
      d="M10.273 8.588v-.54l-.028-.027-.531-.186-.136-.371.263-.564.028-.063-.169-.176-.2-.208-.069.036-.519.277-.358-.105-.227-.6h-.512l-.026.027-.179.551-.363.142-.6-.3-.367.378.035.071.266.539-.149.371-.632.231v.54l.074.023.554.19.149.372-.277.624.367.386.069-.036.52-.276.357.154.228.651h.519l.022-.077.183-.575.353-.154.607.295.367-.381-.035-.073-.269-.534.1-.377Zm-2.187.5a.757.757 0 1 1 .725-.761v.003a.745.745 0 0 1-.725.756Z"
    />
  </svg>
);
const Memo = memo(AzureNetworkFunctionManager);
export default Memo;
