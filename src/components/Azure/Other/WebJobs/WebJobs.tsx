...
const WebJobs = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      ...
      opacity={0.55}
    />
    <circle cx={3.825} cy={7.157} r={2.343} fill="url(#prefix__b)" />
    <g fill="#f2f2f2">
      <path
    ...
    <circle cx={8.763} cy={11.435} r={1.522} fill="url(#prefix__c)" />
    <path
      fill="#f2f2f2"
