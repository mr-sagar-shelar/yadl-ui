...
const CDNProfiles = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <rect
      ...
      fill="#a3a3a3"
      rx={0.52}
      transform="rotate(-90 2.63 10.51)"
    />
    <rect
      width={1.18}
      height={5.26}
      ...
      fill="#7a7a7a"
      rx={0.52}
      transform="rotate(-90 4.295 12.895)"
    />
    <path
      fill="url(#prefix__a)"
