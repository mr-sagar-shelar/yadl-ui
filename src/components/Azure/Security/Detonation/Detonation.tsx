...
const Detonation = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <circle cx={10.646} cy={7.013} r={5.167} fill="url(#prefix__a)" />
    <path
      fill="#f2f2f2"
      d="M14.55 5.973a1.575 1.575 0 1 1-2.952 1.1ZM9.7 7.073a1.575 1.575 0 0 1-2.952-1.1Z"
    />
  </svg>
);
const Memo = memo(Detonation);
export default Memo;
