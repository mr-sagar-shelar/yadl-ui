...
const AzureSQLServerStretchDatabases = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#e8e8e8"
      d="M17.32 9.08c0 .73-1.87 1.33-4.18 1.33S9 9.81 9 9.08s1.87-1.33 4.18-1.33 4.18.59 4.18 1.33"
    />
    <path
      fill="#50e6ff"
      d="M16.35 9c0 .47-1.44.85-3.21.85s-3.2-.41-3.2-.85 1.43-.85 3.2-.85 3.21.38 3.21.85"
    />
    <path
      fill="#32bedd"
      d="M13.14 9.17a8.6 8.6 0 0 0-2.54.32 8.5 8.5 0 0 0 2.54.33 8.5 8.5 0 0 0 2.54-.33 8.6 8.6 0 0 0-2.54-.32"
    />
  </svg>
);
const Memo = memo(AzureSQLServerStretchDatabases);
export default Memo;
