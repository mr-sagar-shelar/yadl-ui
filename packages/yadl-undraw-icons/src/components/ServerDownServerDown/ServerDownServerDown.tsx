...
const ServerDownServerDown = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path fill="#2f2e41" d="M0 51.142c0 77.498 48.618 140.209 108.7 140.209" />
    <path
    ...
    <path d="M968.978 667.466v6.06h-326.01v-4.848l.449-1.212z" opacity={0.1} />
    ...
    <path
      ...
      opacity={0.8}
    />
    <path fill="var(--color-primary)" d="M317.609 150h16v16h-16z" />
    <path
      fill="var(--color-primary)"
    ...
    <path
      ...
      opacity={0.8}
    />
    <path fill="var(--color-primary)" d="M317.609 251h16v16h-16z" />
    <path
      fill="var(--color-primary)"
    ...
    <path
      ...
      opacity={0.8}
    />
    <path fill="var(--color-primary)" d="M317.609 352h16v16h-16z" />
...
const Memo = memo(ServerDownServerDown);
export default Memo;
