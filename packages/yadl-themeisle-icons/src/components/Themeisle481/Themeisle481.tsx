...
const Themeisle481 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      ...
      fillRule="evenodd"
      d="M206.664 47.1c-44.182 0-80 35.817-80 80v159.085c0 44.182 35.818 80 80 80h159.085c4.719 0 9.342-.409 13.836-1.192v-77.817c0-39.465 28.575-72.255 66.164-78.808V127.1c0-44.183-35.817-80-80-80z"
      clipRule="evenodd"
    />
    <path
      stroke="transparent"
      ...
      strokeWidth={22.048}
      d="M233.76 250.849s19.805 12.236 52.834 12.236 52.835-12.236 52.835-12.236"
    />
    <path
      fill="transparent"
      stroke="transparent"
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={22.048}
      d="M499.486 423.731s19.805 12.236 52.835 12.236 52.835-12.236 52.835-12.236"
    />
    <path
      fill="transparent"
      stroke="transparent"
    ...
    <path
      fill="url(#prefix__a)"
      d="M490.885 95.174c15.829 7.852 36.839-2.244 36.839-2.244s-4.669-22.824-20.507-30.665c-15.83-7.852-36.831 2.233-36.831 2.233s4.669 22.824 20.499 30.676"
    />
    <circle
      r={10.75}
      fill="var(--color-primary)"
    ...
    />
    <circle cx={656.056} cy={192.308} r={10.745} fill="var(--color-primary)" />
    ...
    />
    <ellipse cx={138.979} cy={379.664} fill="#E1E4E5" rx={15.516} ry={12.413} />
    <circle
      cx={339.252}
      cy={529.682}
      r={24.765}
