...
const Themeisle95 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <rect
      ...
      rx={36}
    />
    <circle cx={237} cy={157} r={8} fill="transparent" />
    <circle cx={265} cy={157} r={8} fill="transparent" />
    <circle cx={293} cy={157} r={8} fill="transparent" />
    <circle cx={303} cy={294} r={8} fill="transparent" />
    <rect width={257} height={17} x={424} y={355} fill="transparent" rx={8.5} />
    <rect width={239} height={18} x={442} y={304} fill="transparent" rx={9} />
    <rect width={269} height={17} x={412} y={254} fill="transparent" rx={8.5} />
    <path
      stroke="transparent"
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={13.5}
      d="M384 308.677a58 58 0 0 0-8.315-.676c-16.784-.12-32.776 7.239-43.75 20.133S316.113 358.159 318.668 375"
    />
    <path
      stroke="transparent"
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={13.5}
      d="M387 312.5a64.5 64.5 0 0 1-18.89 45.61A64.5 64.5 0 0 1 322.5 377v0a64.5 64.5 0 0 1-45.61-18.89A64.5 64.5 0 0 1 258 312.5v0a64.5 64.5 0 0 1 18.89-45.61A64.5 64.5 0 0 1 322.5 248v0a64.5 64.5 0 0 1 45.61 18.89A64.5 64.5 0 0 1 387 312.5"
      clipRule="evenodd"
    />
    <defs>
      <linearGradient
