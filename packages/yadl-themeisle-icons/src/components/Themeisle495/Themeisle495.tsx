...
const Themeisle495 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      ...
      strokeMiterlimit={10}
      strokeWidth={24}
      d="M309.212 418.654h283.34c44.163 0 67.406-23.244 67.406-67.407V70H241.573v281.247c.233 44.163 23.477 67.407 67.639 67.407"
    />
    <path
      stroke="var(--color-primary)"
      strokeLinecap="round"
    ...
    <path
      fill="url(#prefix__a)"
      d="M748.757 317.135c-19.025 9.437-44.276-2.697-44.276-2.697s5.611-27.431 24.647-36.856c19.025-9.437 44.266 2.685 44.266 2.685s-5.612 27.43-24.637 36.868"
    />
    <path
      fill="url(#prefix__b)"
      d="M149.661 328.773c17.774 10.653 43.274.805 43.274.805s-3.334-27.115-21.119-37.755c-17.774-10.653-43.263-.817-43.263-.817s3.334 27.115 21.108 37.767"
    />
    <circle
      r={12.955}
      fill="#E1E4E5"
