...
const Themeisle235 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={14.86}
      d="M407.028 353.326h109.358v62.918H407.028z"
      clipRule="evenodd"
    />
    <path
      stroke="transparent"
    ...
    <path
      fill="url(#prefix__a)"
      d="M766.076 251.897c-27.583 13.683-64.193-3.91-64.193-3.91s8.137-39.77 35.734-53.434c27.583-13.683 64.179 3.892 64.179 3.892s-8.137 39.769-35.72 53.452"
    />
    <path
      fill="url(#prefix__b)"
      d="M296.764 243.914c15.97 9.571 38.881.723 38.881.723s-2.996-24.362-18.975-33.922c-15.97-9.572-38.871-.735-38.871-.735s2.996 24.363 18.965 33.934"
    />
    <circle
      cx={723.764}
      cy={362.494}
    ...
    />
    <circle r={9.313} fill="#E1E4E5" transform="matrix(-1 0 0 1 573 496.499)" />
    <circle
      r={10.354}
      fill="#E1E4E5"
    ...
    <path
      fill="#E1E4E5"
      d="M651.021 287.477h.248c1.474 20.884 17.006 21.206 17.006 21.206s-17.127.334-17.127 24.466c0-24.132-17.127-24.466-17.127-24.466s15.525-.322 17-21.206M149.815 458.421h.13c.771 11.338 8.891 11.513 8.891 11.513s-8.954.182-8.954 13.283c0-13.101-8.955-13.283-8.955-13.283s8.117-.175 8.888-11.513"
    />
    <defs>
      <linearGradient
        id="prefix__a"
