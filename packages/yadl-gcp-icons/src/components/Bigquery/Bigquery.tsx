...
const Bigquery = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
    ...
    <g data-name="Product Icons">
      <path
        d="M6.73 10.83v2.63a4.9 4.9 0 0 0 1.71 1.74v-4.37Z"
        className="prefix__cls-1"
      />
      <path
        d="M9.89 8.41v7.53A8 8 0 0 0 11 16a8 8 0 0 0 1 0V8.41Z"
