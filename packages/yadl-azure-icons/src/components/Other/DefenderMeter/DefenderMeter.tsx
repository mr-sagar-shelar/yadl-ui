...
const DefenderMeter = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="url(#prefix__e)"
      fillRule="evenodd"
      d="M1.333 1.333h15.334v10H1.333z"
      clipRule="evenodd"
    />
    <path fill="url(#prefix__f)" d="M1.667 16.333h1.666v-.666H1.667z" />
    <path fill="url(#prefix__g)" d="M16.333 16.333h-1.666v-.666h1.666z" />
    <path
      fill="url(#prefix__h)"
      fillRule="evenodd"
      d="m5.312 5.373-.389-.595a6.4 6.4 0 0 1 1.375-.672l.424.804.59-.311-.363-.689a8.3 8.3 0 0 1 1.718-.237v.771h.666v-.771A8.3 8.3 0 0 1 11 3.897l-.319.684.605.282.361-.776a6.4 6.4 0 0 1 1.49.731l-.429.527.517.421.442-.542c.277.242.473.472.59.654l.005.006-.43.585.537.395.703-.957-.255-.393c-.2-.307-.534-.671-.994-1.024a7 7 0 0 0-2.258-1.13A9 9 0 0 0 9 3c-2.158 0-3.734.686-4.731 1.42-.509.375-.873.767-1.086 1.094l-.255.393.703.957.538-.395-.43-.585.003-.006c.126-.194.34-.442.645-.702l.367.562z"
    ...
    <path
      fill="#005BA1"
      fillRule="evenodd"
      d="M16.667 1.333H1.333v10h15.334zM16 2H2v8.667h14z"
      clipRule="evenodd"
    />
    <path
      fill="#0078D4"
    ...
    <path
      fill="#767676"
      d="M10.882 11.842a1.602 1.602 0 1 0-3.201.122 1.602 1.602 0 0 0 3.201-.122"
    />
    <defs>
      <linearGradient
        id="prefix__a"
