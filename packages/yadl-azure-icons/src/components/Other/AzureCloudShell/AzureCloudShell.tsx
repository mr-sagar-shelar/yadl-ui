...
const AzureCloudShell = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="#bfbfbf"
      d="M.063 5.7h15.53v9.254a.23.23 0 0 1-.231.231H.294a.23.23 0 0 1-.231-.231z"
    />
...
const Memo = memo(AzureCloudShell);
export default Memo;
