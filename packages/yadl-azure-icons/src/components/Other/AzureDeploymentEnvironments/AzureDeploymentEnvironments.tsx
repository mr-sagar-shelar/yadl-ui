...
const AzureDeploymentEnvironments = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="url(#prefix__a)"
      d="M18 16.686H0l3.332-3.149a.58.58 0 0 1 .4-.16H14.68a.58.58 0 0 1 .438.2z"
    />
    <path
      fill="#3cd4c2"
      d="M0 16.686h18v.41a.584.584 0 0 1-.586.586H.586A.586.586 0 0 1 0 17.096z"
    />
    <path
      fill="url(#prefix__b)"
...
const Memo = memo(AzureDeploymentEnvironments);
export default Memo;
