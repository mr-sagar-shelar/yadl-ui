...
const WebAppDatabase = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      ...
      opacity={0.55}
    />
    <circle cx={2.269} cy={4.764} r={1.595} fill="url(#prefix__c)" />
    <path
      fill="#f2f2f2"
      ...
      opacity={0.55}
    />
    <circle cx={5.629} cy={7.68} r={1.04} fill="url(#prefix__d)" />
    <path
      fill="#f2f2f2"
...
const Memo = memo(WebAppDatabase);
export default Memo;
