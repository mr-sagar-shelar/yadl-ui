...
const ServerlessSearch = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      ...
      <linearGradient
        ...
        y1={1125.664}
        y2={1134.411}
        gradientTransform="matrix(1.156 0 0 -1.029 242.021 1176.241)"
        gradientUnits="userSpaceOnUse"
      >
    ...
    <path
      fill="#f2f2f2"
      d="M12.33 4.271a3.07 3.07 0 0 0-5.61.85 3.16 3.16 0 0 0 .33 2.27l-2.34 2.37a.79.79 0 0 0-.003 1.117l.003.003c.148.149.35.232.56.23a.76.76 0 0 0 .56-.23l2.33-2.36c.253.147.526.258.81.33a3.08 3.08 0 0 0 3.36-4.58m-.54 2.1a2.16 2.16 0 0 1-2.09 1.65 1.8 1.8 0 0 1-.51-.07 1.9 1.9 0 0 1-.7-.32 2.1 2.1 0 0 1-.56-.56 2.17 2.17 0 0 1-.31-1.73 2.14 2.14 0 0 1 2.08-1.66q.263 0 .52.06a2.18 2.18 0 0 1 1.32 1c.299.488.389 1.075.25 1.63"
    />
...
const Memo = memo(ServerlessSearch);
export default Memo;
