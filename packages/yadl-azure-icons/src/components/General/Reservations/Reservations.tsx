...
const Reservations = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <rect
      ...
      fill="#7a7a7a"
      rx={0.52}
      transform="rotate(135 10.385 10.693)"
    />
    <circle cx={8.81} cy={9.08} r={1.2} fill="url(#prefix__b)" />
  </svg>
);
const Memo = memo(Reservations);
export default Memo;
