...
const Scheduler = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <circle cx={9.71} cy={8.252} r={8.252} fill="url(#prefix__a)" />
    ...
    />
    <circle cx={9.747} cy={8.238} r={1.169} fill="url(#prefix__b)" />
    <path
      fill="#86d633"
