...
const WebTest = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      ...
      opacity={0.55}
    />
    <circle cx={3.439} cy={7.251} r={2.424} fill="url(#prefix__b)" />
    <g fill="#f2f2f2">
      <path
    ...
    <circle cx={8.547} cy={11.677} r={1.575} fill="url(#prefix__c)" />
    <path
      fill="#f2f2f2"
