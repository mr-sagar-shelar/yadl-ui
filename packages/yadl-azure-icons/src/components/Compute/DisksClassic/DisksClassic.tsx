...
const DisksClassic = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path fill="url(#prefix__a)" d="M15.35 13.4" />
    <ellipse cx={8.96} cy={4.99} fill="url(#prefix__b)" rx={7.5} ry={3.08} />
