...
const EntraIdentityCustomRoles = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      ...
      opacity={0.8}
    />
    <circle cx={7.904} cy={4.466} r={4.367} fill="url(#prefix__b)" />
...
const Memo = memo(EntraIdentityCustomRoles);
export default Memo;
