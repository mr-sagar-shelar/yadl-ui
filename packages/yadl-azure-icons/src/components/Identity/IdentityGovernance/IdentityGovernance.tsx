...
const IdentityGovernance = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="#32bedd"
      d="M5.18 1.87a2.09 2.09 0 1 1-3 0 2.09 2.09 0 0 1 3 0"
    />
    <path
      fill="#fff"
      d="M4.42 4.07a1 1 0 0 0 0-1.45 1 1 0 0 0-1.42 0 1 1 0 0 0 0 1.45 1 1 0 0 0 1.44 0"
    />
    <path
      fill="#32bedd"
      d="M13.18 1.87a2.09 2.09 0 1 1 0 3 2.09 2.09 0 0 1 0-2.95Z"
    />
    <path fill="#fff" d="M15.38 2.62a1 1 0 1 0 0 1.45 1 1 0 0 0 0-1.45" />
    <path
      fill="#32bedd"
      d="M12.82 16.13a2.09 2.09 0 1 1 3 0 2.09 2.09 0 0 1-3 0"
    />
    <path
      fill="#fff"
      d="M13.58 13.93a1 1 0 0 0 0 1.45 1 1 0 0 0 1.44 0 1 1 0 0 0 0-1.45 1 1 0 0 0-1.44 0"
    />
    <path
      fill="#32bedd"
      d="M4.82 16.13a2.09 2.09 0 1 1 0-2.95 2.09 2.09 0 0 1 0 2.95"
    />
    ...
    <path
      fill="#fff"
      d="M9 8.31a2.4 2.4 0 0 1-1.3-.38L9 11.28 10.27 8A2.37 2.37 0 0 1 9 8.31"
      opacity={0.8}
    />
    <circle cx={9.01} cy={5.92} r={2.39} fill="url(#prefix__b)" />
  </svg>
);
const Memo = memo(IdentityGovernance);
export default Memo;
