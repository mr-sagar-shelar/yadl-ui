...
const VerifiableCredentials = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="#f2f2f2"
      d="M6.44 5.923a1.7 1.7 0 0 1-.9-.271l.9 2.38.91-2.363a1.7 1.7 0 0 1-.91.254"
    />
    <circle cx={6.429} cy={4.222} r={1.701} fill="url(#prefix__c)" />
    <path
      fill="url(#prefix__d)"
...
const Memo = memo(VerifiableCredentials);
export default Memo;
