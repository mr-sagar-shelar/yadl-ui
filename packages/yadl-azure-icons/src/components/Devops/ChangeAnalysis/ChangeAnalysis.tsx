...
const ChangeAnalysis = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    <defs>
      <linearGradient
        ...
        y1={86.754}
        y2={90.154}
        gradientTransform="scale(1 -1)rotate(-5.4 -1065.302 -338.595)"
      ...
      <linearGradient
        ...
        y1={16.227}
        y2={19.627}
        gradientTransform="matrix(1 .011 .011 -1 3.112 33.079)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset={0} stopColor="#5e9624" />
        <stop offset={0.82} stopColor="#86d633" />
      ...
      <linearGradient
        ...
        y1={87.696}
        y2={91.096}
        gradientTransform="matrix(.997 .091 .091 -.997 27.793 101.286)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset={0} stopColor="#5e9624" />
        <stop offset={0.82} stopColor="#86d633" />
      ...
      <linearGradient
        ...
        y1={80.916}
        y2={84.316}
        gradientTransform="matrix(.997 .091 .091 -.997 27.799 101.286)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset={0} stopColor="#5e9624" />
        <stop offset={0.82} stopColor="#86d633" />
    ...
    <path
      fill="#76bc2d"
      d="m2.59 16.55-1.06-.94 5.18-5.8 4.41 4.54 4.16-4.41 1.03.97-5.18 5.49-4.37-4.52z"
    />
    <circle cx={6.732} cy={10.857} r={1.7} fill="url(#prefix__a)" />
    <circle cx={11.122} cy={15.236} r={1.7} fill="url(#prefix__b)" />
    <circle cx={15.799} cy={10.277} r={1.7} fill="url(#prefix__c)" />
    <circle cx={2.203} cy={15.8} r={1.7} fill="url(#prefix__d)" />
    <path
      fill="#0078d4"
      fillRule="evenodd"
      d="M14.18 8.308 11 11.529 7.791 8.308a4.45 4.45 0 0 1-.086-6.293l.086-.085a4.47 4.47 0 0 1 6.323-.066l.066.066a4.47 4.47 0 0 1 .055 6.323Z"
    />
    <path
      fill="#fff"
...
const Memo = memo(ChangeAnalysis);
export default Memo;
