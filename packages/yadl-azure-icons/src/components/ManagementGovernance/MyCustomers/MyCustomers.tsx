...
const MyCustomers = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="#fff"
      d="M6.77 9.14a3.7 3.7 0 0 1-2-.6l2 5.25 2-5.21a3.8 3.8 0 0 1-2 .56"
      opacity={0.8}
    />
    <circle cx={6.74} cy={5.39} r={3.75} fill="url(#prefix__b)" />
  </svg>
);
const Memo = memo(MyCustomers);
export default Memo;
