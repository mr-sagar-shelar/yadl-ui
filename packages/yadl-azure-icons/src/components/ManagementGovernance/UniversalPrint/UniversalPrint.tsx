...
const UniversalPrint = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="#5ea0ef"
      d="M7.106 8.18H17.4a.6.6 0 0 1 .6.6v6.1H6.507v-6.1a.6.6 0 0 1 .599-.6"
    />
    ...
    <path
      fill="url(#prefix__c)"
      d="M8.57 12.512h7.367v3.823a.3.3 0 0 1-.3.3H8.869a.3.3 0 0 1-.3-.3v-3.823z"
    />
  </svg>
);
const Memo = memo(UniversalPrint);
export default Memo;
