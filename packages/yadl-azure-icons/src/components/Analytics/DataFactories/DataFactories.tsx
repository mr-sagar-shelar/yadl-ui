...
const DataFactories = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="url(#prefix__a)"
      d="M4.75 3.58C2.4 3.58.5 2.89.5 2v14.93a.56.56 0 0 0 .57.57H9V2c0 .89-1.9 1.58-4.25 1.58"
    />
    <rect
      width={2.27}
      height={2.27}
    ...
    <path
      fill="#eaeaea"
      d="M9 2c0 .85-1.9 1.54-4.25 1.54S.5 2.89.5 2 2.4.5 4.75.5 9 1.19 9 2"
    />
    <path
      fill="#50e6ff"
      d="M8 1.91c0 .55-1.46 1-3.26 1s-3.26-.43-3.26-1S3 .94 4.75.94 8 1.37 8 1.91"
    />
    <path
      fill="#198ab3"
