...
const LogAnalyticsWorkspaces = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="#fff"
      d="M7.59 5.65h1.36v4.08H7.59zM10.31 7.01h1.36v2.72h-1.36zM13.03 4.29h1.36v5.44h-1.36z"
    />
  </svg>
);
const Memo = memo(LogAnalyticsWorkspaces);
export default Memo;
