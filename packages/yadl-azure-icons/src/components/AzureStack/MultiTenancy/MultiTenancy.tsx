...
const MultiTenancy = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      ...
      opacity={0.8}
    />
    <circle cx={6.277} cy={3.932} r={3.496} fill="url(#prefix__b)" />
    <path
      fill="url(#prefix__c)"
      d="m13.564 9.54-4.436 6.211 4.436 1.813L18 15.751z"
    />
    <path fill="#50e6ff" d="m13.564 9.54-4.436 6.211 4.436 1.813z" />
  </svg>
);
const Memo = memo(MultiTenancy);
export default Memo;
