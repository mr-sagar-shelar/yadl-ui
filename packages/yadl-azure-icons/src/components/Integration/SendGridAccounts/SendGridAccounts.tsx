...
const SendGridAccounts = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path
      fill="#005ba1"
      d="M6.22 11.83H.67v-5.1a.57.57 0 0 1 .57-.56h5Zm5.56 0H6.22v5.67h5a.57.57 0 0 0 .57-.57Z"
    />
    <path
      fill="#0078d4"
      d="M11.78 11.83H6.22V6.17h5.56Zm-5.56 0H.67v5.1a.57.57 0 0 0 .57.57h5Z"
    />
    <path
      fill="#0078d4"
...
const Memo = memo(SendGridAccounts);
export default Memo;
