...
const IntegrationAccounts = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" {...props}>
    ...
    <path fill="url(#prefix__a)" d="M3.62 11.62H6.5v2.88H3.62Z" />
    <path fill="#e62323" d="M7.62 11.62h2.88v2.88H7.62Z" />
    <path fill="url(#prefix__b)" d="M11.62 11.62h2.88v2.88h-2.88Z" />
  </svg>
);
const Memo = memo(IntegrationAccounts);
export default Memo;
